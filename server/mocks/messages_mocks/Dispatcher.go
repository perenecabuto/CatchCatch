...
// Subscribe provides a mock function with given fields: topic, callback
func (_m *Dispatcher) Subscribe(topic string, callback messages.OnMessage) error {
	ret := _m.Called(topic, callback)

	var r0 error
	if rf, ok := ret.Get(0).(func(string, messages.OnMessage) error); ok {
